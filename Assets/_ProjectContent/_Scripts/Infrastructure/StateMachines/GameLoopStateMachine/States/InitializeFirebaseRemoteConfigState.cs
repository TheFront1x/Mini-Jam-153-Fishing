...
{
    public class InitializeFirebaseRemoteConfigState : BaseGameLoopState, IEnterableState
    {
        private readonly IConditionalLoggingService _conditionalLoggingService;

        public override string StateName => nameof(InitializeFirebaseRemoteConfigState);

        [Inject]
        public InitializeFirebaseRemoteConfigState(
